...
public class TinyDB {
    ...
    public ArrayList<BestSellerModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<BestSellerModel> objects =  new ArrayList<BestSellerModel>();

        for(String jObjString : objStrings){
            BestSellerModel value  = gson.fromJson(jObjString,  BestSellerModel.class);
            objects.add(value);
        }
        return objects;
    }
...
//    }
//
    public void putListObject(String key, ArrayList<BestSellerModel> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (BestSellerModel player : playerList) {
